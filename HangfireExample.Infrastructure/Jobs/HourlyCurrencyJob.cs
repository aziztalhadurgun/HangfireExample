...
public class HourlyCurrencyJob(ILogger<HourlyCurrencyJob> logger, IOptions<CurrencyServiceOptions> options) : IJob
{
    private readonly ILogger<HourlyCurrencyJob> _logger = logger;
    ...
    public async Task Execute()
    {
        try
        {
            string address = $"{_options.Address}/Currency/FetchAndSaveHourlyCurrencies"; 
